...
export const NOTIFICATION_META: Record<NotificationType, NotificationMeta> = {
  ...
  follow_up_due:     { label: 'Follow-ups',   description: 'When a scheduled follow-up is due',  color: 'text-violet-600', bgColor: 'bg-violet-50 dark:bg-violet-950/40', icon: '📅' },
  lead_assigned:     { label: 'Activities',   description: 'When a lead is assigned to you',     color: 'text-sky-600',    bgColor: 'bg-sky-50 dark:bg-sky-950/40',       icon: '👤' },
